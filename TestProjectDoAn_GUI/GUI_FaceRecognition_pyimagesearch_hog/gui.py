...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.trainbuttonhog = tk.Button(self.label_frame, text="Train The Model HOG", font='Helvetica 12 bold', fg="#ffffff", bg="#3366FF",command=self.trainmodelhog)
