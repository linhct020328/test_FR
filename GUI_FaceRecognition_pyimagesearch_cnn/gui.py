...
from encode_faces_cnn import *
from build_face_dataset import *

from mainMqttPubAes256CBC_cnn import *
    ...
    def edit_name(self):
        ...
        if messagebox.askokcancel("Quit", "Are you sure?"):
            for line in self.listNames.curselection():
                ...
                self.controller.frames["PageTwo"].refresh_names()
                try:
                    if messagebox.askyesnocancel("Quit", "you want to train again using model cnn?"):
                            startTrainCnn()
                            messagebox.showinfo("SUCCESS", "The modele cnn has been successfully trained!")
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.trainbuttoncnn = tk.Button(self.label_frame, text="Train The Model Cnn", font='Helvetica 12 bold', fg="#ffffff", bg="#3366FF",command=self.trainmodelcnn)
        ...
        self.trainbuttoncnn.grid(row=2, column=0, sticky="ew", ipadx=10, ipady=4, padx=20, pady=10)
...
class PageFour(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.lable = tk.Label(self, text="START FACIAL RECOGNITION MODEL CNN", fg="#3366FF", font=self.controller.title_font)
        ...
        self.button2 = tk.Button(self.label_frame, text="Face Recognition CNN", font='Helvetica 12 bold', command=self.openwebcamcnn, fg="#ffffff", bg="#3366FF")
